...
traffic and the explicit first-party OpenAI API `upstreamWebsocket` opt-in keep the behavior above; arbitrary provider endpoints remain on HTTP/SSE. It does not
